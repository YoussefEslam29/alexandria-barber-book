  ...
  return (
    <section id="services" className="py-24 px-4">
      <div className="container mx-auto max-w-5xl">
        <p className="text-primary text-sm tracking-[0.3em] uppercase text-center mb-3">{t("whatWeOffer")}</p>
        <h2 className="font-heading text-3xl md:text-4xl text-foreground text-center mb-16">{t("ourServices")}</h2>
